...
ActiveRecord::Schema.define(version: 2021_02_23_021507) do
  ...
  create_table "orders", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "english"
    t.string "japanese"
    t.index ["user_id", "created_at"], name: "index_orders_on_user_id_and_word_id_and_created_at"
  end
  ...
  create_table "responses", id: :integer, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "order_id", "created_at"], name: "index_responses_on_user_id_and_order_id_and_created_at"
  end
